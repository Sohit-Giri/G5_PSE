...
class CourseForm(forms.ModelForm):
    class Meta:
        model = Course
        fields = ['title', 'instructor', 'duration', 'students_count', 'price', 'is_free']  # Ensure these fields match your model
...
class UserProfileForm(forms.ModelForm):
    class Meta:
        model = UserProfile
        fields = ('first_name', 'last_name', 'profile_photo', 'mobile_number')
