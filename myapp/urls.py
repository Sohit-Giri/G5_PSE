...
from .views import contact_view, profile_view, edit_profile_view, course_detail_view, contact_view, about_view, signup_view, login_view, home_view, logout_view, courses_view, enroll_in_course, course_detail_view, add_course, edit_course, delete_course, enroll_success
